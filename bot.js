// Глобальная переменная CONFIG должна быть доступна
     if (!window.CONFIG) {
         console.error('CONFIG не определён. Убедитесь, что index.html загружает CONFIG перед bot.js');
     }
     ...
     export async function requestNotificationPermission() {
         ...
         const permission = await Notification依頼Permission();
